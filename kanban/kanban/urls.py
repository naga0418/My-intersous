...
from . import views #views.pyをインポート　中のメソッドを使う

app_name = "kanban"

urlpatterns = [
    path("",views.index,name="index"), #views.pyにあるindexメソッドを使用
    # path("home/",views.home,name="home"), #home/にアクセスがあったらviews.pyにあるhomeメソッドを使用
    path("home/",views.HomeView.as_view(),name="home"),
    path("signup/", views.signup, name="signup"), #name=""のところはhtmlファイルに記載されている　'アプリ名:名前'　のところに対応する。
